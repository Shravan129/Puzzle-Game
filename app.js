//defining the no of row and columns
var rows = 3;
var columns = 3;
...
//declaring the turns varible
var turns =0;
var imgOrder = ["4","5","6","8","9","3","2","1","7"];

//function to randomize the imgOrder array for shuffled image whenever reloaded
...
window.onload = function(){
    for (let r=0;r<rows;r++){
        for (let c=0;c<columns;c++){
            ...
            //drag functionality
            // title.addEventListener("click",dragStart);
...
//what should happen at the end of drag 
function dragEnd(){
